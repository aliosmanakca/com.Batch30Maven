...
public class C03 {
    ...
    public void test01() throws InterruptedException {
        ...
        emailBox.sendKeys("merhaba"+ Keys.ENTER);
        Thread.sleep(2000);
        WebElement hataYazisi = driver.findElement(By.xpath("//div[@id='create_account_error']"));
        Assert.assertTrue("hata mesaji gorulmedi", hataYazisi.isDisplayed());
    }
    @AfterClass
